...
export default function NavBar() {
  ...
  return (
    <div>
      <div className='fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-20 py-2 bg-black max-lg:px-10'>
        ...
        <FaBarsStaggered className='text-white cursor-pointer' onClick={toggleMenu}/>
      </div>
      <div className={`${isMenuOpen ? 'flex justify-center py-5 bg-black mt-[30px]' : ' -translate-y-full'} duration-500 fixed right-0 left-0 z-40 rounded-b-2xl`}>
